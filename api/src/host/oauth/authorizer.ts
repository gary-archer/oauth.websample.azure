...
export class Authorizer {
    ...
    public async authorizeRequestAndGetClaims(request: Request): Promise<ClaimsPrincipal> {
        ...
        // The API looks up extra claims when the access token is first received
        // The goal is to keep JWT access tokens issued to web and mobile clients confidential
        // The usual mechanism is to use an opaque reference token format but Azure AD does not support this
