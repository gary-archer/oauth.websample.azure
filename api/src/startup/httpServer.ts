...
export class HttpServer {
    ...
    public async configure(): Promise<Application> {
        ...
        // To indicate the concrete claims type we use supplier functions
        // This enables us to work around TypeScript generic type erasure issues
        await framework.withApiBasePath('/api/')
                       .addUnsecuredPath('/api/unsecure')
