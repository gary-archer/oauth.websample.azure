...
export class Authenticator {
     ...
     * Note that on page reloads or when opening new tabs there may be no refresh token
    ...
    private async _performTokenRefresh(): Promise<void> {
        ...
        try {
            ...
            // Login required could be returned for iframe renewal redirects
            // Invalid grant is returned when the refresh token expires, such as when a browser is left overnight
